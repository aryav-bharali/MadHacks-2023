...
// const body = `One of the main literary elements Blanco employs in the poem is metaphor. Throughout the poem, the act of shaving is compared to various other activities and experiences, such as "painting" and "a meditation" (lines 9 and 20). By using these metaphors, Blanco suggests that the ritual of shaving is not just a physical act, but also a mental and emotional one. The poem suggests that the speaker is engaging in self-care and self-reflection in the act of shaving, and the metaphors serve to reinforce the idea that this is not just a superficial task.`
